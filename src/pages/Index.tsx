...
const properties = [
  { icon: "CheckCircle", title: "Достоверность", desc: "Показывает, что информация не искажает истинного положения дел и не имеет ошибок. Недостоверная информация может приводить к сбоям, трагедиям и конфликтам.", color: "#ec4899" },
  { icon: "Layers", title: "Полнота", desc: "Информация должна содержать достаточный для принятия верных и взвешенных решений набор данных.", color: "#f472b6" },
  { icon: "Scale", title: "Объективность", desc: "Информация не должна отражать чьё-либо мнение.", color: "#db2777" },
  { icon: "Clock", title: "Актуальность", desc: "Информация должна соответствовать действительности в настоящее время. Устаревшие данные негативно влияют на результат.", color: "#be185d" },
  { icon: "Eye", title: "Понятность", desc: "Любая информация должна быть изложена на понятном языке или представлена в понятном виде тому, для кого она предназначена.", color: "#ec4899" },
  { icon: "Unlock", title: "Доступность", desc: "Характеризует свободу доступа к информации всем заинтересованным пользователям.", color: "#f472b6" },
  { icon: "Search", title: "Релевантность", desc: "Соответствие информации запросам пользователя или решаемой задаче. Релевантная информация помогает найти ответ, нерелевантная — отвлекает.", color: "#db2777" },
  { icon: "LayoutDashboard", title: "Эргономичность", desc: "Удобство формы представления информации. Эргономичная информация хорошо структурирована, визуализирована и адаптирована под аудиторию.", color: "#be185d" },
  { icon: "Gem", title: "Ценность (полезность)", desc: "Способность информации помогать в достижении конкретной цели. Одни и те же данные могут быть бесценны для одного и бесполезны для другого.", color: "#ec4899" },
  { icon: "Shield", title: "Защищённость", desc: "Устойчивость информации к несанкционированному доступу, искажению или разрушению. Защищённая информация доступна только уполномоченным лицам.", color: "#f472b6" },
  { icon: "Target", title: "Адекватность", desc: "Точное соответствие информации реальному объекту или процессу. Адекватная информация не искажает суть явления, даже если упрощена.", color: "#db2777" },
];
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="mt-16 glass-card rounded-3xl p-8 border border-pink-200">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { title: "По способу восприятия", items: ["Визуальная", "Звуковая", "Вкусовая", "Обонятельная", "Тактильная"] },
                { title: "По форме представления", items: ["Графическая", "Текстовая", "Акустическая", "Числовая", "Комбинированная (мультимедийная)"] },
                { title: "По назначению", items: ["Массовая", "Специальная", "Секретная", "Личная"] },
              ].map((group, i) => (
                <div key={i}>
